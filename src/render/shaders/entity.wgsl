...
//   @location(3) line_dir:    vec2<f32>  (offset 28,  8 bytes)
// stride = 36 bytes
//
...
//
// `line_dir` is a per-vertex normalised direction vector describing the
// tangent of the line at this vertex.  Passed through for future use
// (line width, dashes, arrowheads — v0.3.1+).  In v0.3.0 it has no
// fragment effect.
...
fn fs_main(in: VertexOutput) -> @location(0) vec4<f32> {
    ...
    // line_dir is available here for v0.3.1+ features (line width, dashes,
    // arrowheads).  No fragment effect in v0.3.0.
